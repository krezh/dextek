...
variable "talos_version" {
  ...
  type        = string
  default     = "v1.7.6" # renovate: datasource=github-releases depName=siderolabs/talos
}

variable "kubernetes_version" {
  description = "The Kubernetes version"
  type        = string
  default     = "v1.31.0" # renovate: datasource=docker depName=ghcr.io/siderolabs/kubelet
}
