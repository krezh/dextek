...
variable "talos_version" {
  ...
  type        = string
  default     = "v1.8.1" # renovate: datasource=docker depName=ghcr.io/siderolabs/installer
}

variable "kubernetes_version" {
  description = "The Kubernetes version"
  type        = string
  default     = "v1.31.2" # renovate: datasource=docker depName=ghcr.io/siderolabs/kubelet
}
