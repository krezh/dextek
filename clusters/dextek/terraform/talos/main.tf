module "talos" {
  ...
  talos_version          = "v1.12.6" # renovate: datasource=github-releases depName=siderolabs/talos
  kubernetes_version     = "v1.35.4" # renovate: datasource=docker depName=ghcr.io/siderolabs/kubelet
