module "talos" {
  ...
  talos_version          = "v1.11.6" # renovate: datasource=github-releases depName=siderolabs/talos
  kubernetes_version     = "v1.34.3" # renovate: datasource=docker depName=ghcr.io/siderolabs/kubelet
