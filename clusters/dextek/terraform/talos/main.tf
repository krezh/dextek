module "talos" {
  ...
  talos_version          = "v1.13.2" # renovate: datasource=custom.talos-factory depName=siderolabs/talos
  kubernetes_version     = "v1.36.1" # renovate: datasource=docker depName=ghcr.io/siderolabs/kubelet
